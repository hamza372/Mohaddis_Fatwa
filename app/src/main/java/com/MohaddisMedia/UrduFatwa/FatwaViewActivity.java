...
public class FatwaViewActivity extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch ( item.getItemId()) {
                case R.id.fist_page:
                    startActivity(new Intent(FatwaViewActivity.this, MainActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.kutub:
                    startActivity(new Intent(FatwaViewActivity.this, KutubActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.question:
                    startActivity(new Intent(FatwaViewActivity.this, QuestinActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.topic:
                    Intent intent = new Intent(FatwaViewActivity.this, TopicsActivity.class);
                    intent.putExtra(Constants.TOPIC,0);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.fav:
                    startActivity(new Intent(FatwaViewActivity.this, FavouriteFatwaActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
            }
            return  true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id == R.id.firstpg) {
                    Intent intent = new Intent(FatwaViewActivity.this, MainActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);

                } else if (id == R.id.kutub) {
                    Intent intent = new Intent(FatwaViewActivity.this, KutubActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.qs) {
                    Intent intent = new Intent(FatwaViewActivity.this, QuestinActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.latest) {
                    Intent intent = null;
                    intent = new Intent(FatwaViewActivity.this, Fatwa_ListActivity_Networking.class);
                    intent.putExtra(Constants.TITLE, "تازہ ترین جوابات");
                    intent.putExtra(Constants.LATEST,true);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                }  else if (id == R.id.subs) {
                    Intent intent = new Intent(FatwaViewActivity.this, Subscribe.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.other) {
                    Intent intent = new Intent(FatwaViewActivity.this, OtherProjects.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.favo) {
                    Intent intent = new Intent(FatwaViewActivity.this, FavouriteFatwaActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                }
        ...
        question.setText(Html.fromHtml(fatwaDataModel.getQuestion().replaceAll(searchText, "<span style=\"background-color: #ffff00;\">" + searchText + "</span>")));
        ...
        if(fatwaDataModel.getAnswer() != null && !fatwaDataModel.getAnswer().equals("")) {
            ...
            if(!searchText.equals("-1"))
            {
                ...
                if(fatwaDataModel.getAnswer().contains(searchText)) {
                    str = str.replaceAll(searchText, "<span style=\"background-color: #ffff00;\">" + searchText + "</span>");
                }else{
...
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
//                List<Integer> list = findWordUpgrade(Html.fromHtml(fatwaDataModel.getAnswer(), Html.FROM_HTML_MODE_COMPACT).toString(),Constants.SEARCHTEXT);
//                Log.d("tryAnswer",Html.fromHtml(fatwaDataModel.getAnswer(), Html.FROM_HTML_MODE_COMPACT).toString());
//                SpannableString ss = new SpannableString(Html.fromHtml(fatwaDataModel.getAnswer(), Html.FROM_HTML_MODE_COMPACT));
//                BackgroundColorSpan bg = new BackgroundColorSpan(Color.YELLOW);
//                for(int i : list) {
//                    ss.setSpan(bg, i, i+Constants.SEARCHTEXT.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//                }
//                answer.setText(ss);
//                //answer.setText(Html.fromHtml(fatwaDataModel.getAnswer(), Html.FROM_HTML_MODE_COMPACT));
//            } else {
//                List<Integer> list = findWordUpgrade(Html.fromHtml(fatwaDataModel.getAnswer()).toString(),Constants.SEARCHTEXT);
//                //answer.setText(Html.fromHtml(fatwaDataModel.getAnswer()));
//                SpannableString ss = new SpannableString(Html.fromHtml(fatwaDataModel.getAnswer()));
//                BackgroundColorSpan bg = new BackgroundColorSpan(Color.YELLOW);
//                for(int i : list) {
//                    ss.setSpan(bg, i, i+Constants.SEARCHTEXT.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//                }
...
//            }
        ...
        favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!favouriteDBHelper.isFatwaFavourite(fatwaDataModel.getId())) {
                    ...
                    Toast.makeText(FatwaViewActivity.this, "Added to favourites", Toast.LENGTH_SHORT).show();
                    favourite.setImageResource(R.drawable.ic_star_black_24dp);
                }else {
                    favourite.setImageResource(R.drawable.ic_star_border_black_24dp);
                    favouriteDBHelper.deleteFatwa(fatwaDataModel.getId());
                    Toast.makeText(FatwaViewActivity.this, "Removed from favourites", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                        Toast.makeText(FatwaViewActivity.this, "Starting...", Toast.LENGTH_SHORT).show();
                        ...
                        ActivityCompat.requestPermissions(FatwaViewActivity.this,
        ...
        copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FatwaViewActivity.this, "Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    Activity activity = FatwaViewActivity.this;
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            try {
                                fatwaDataModel.setAnswer(questionObj.getString("answer"));
            ...
            protected void onPostExecute(Void aVoid) {
               ...
               // Toast.makeText(FatwaViewActivity.this, "therre", Toast.LENGTH_SHORT).show();
                ...
                if(fatwaDataModel.getAnswer() != null) {
                    ...
                    if(!searchText.equals("-1"))
                    {
                        str =  fatwaDataModel.getAnswer().replaceAll(searchText, "<span style=\"background-color: #ffff00;\">" + searchText   + "</span>");
                    }else{
                        str = fatwaDataModel.getAnswer();
                    }
                    str ="<!DOCTYPE html>\n" +
    ...
    {
        Dialog dialog = new Dialog(FatwaViewActivity.this);
