...
public class Fatwa_ListActivity_Networking extends AppCompatActivity {
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            {
                case R.id.fist_page:
                    startActivity(new Intent(Fatwa_ListActivity_Networking.this, MainActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.kutub:
                    startActivity(new Intent(Fatwa_ListActivity_Networking.this, KutubActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.question:
                    startActivity(new Intent(Fatwa_ListActivity_Networking.this, QuestinActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.topic:
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, TopicsActivity.class);
                    intent.putExtra(Constants.TOPIC,0);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
                case R.id.fav:
                    startActivity(new Intent(Fatwa_ListActivity_Networking.this, FavouriteFatwaActivity.class));
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                    break;
            }
            return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   Log.d("tryNetwork",isNetworkAvailable()+"    "+isOnline());
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id == R.id.firstpg) {
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, MainActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.kutub) {
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, KutubActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.qs) {
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, QuestinActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.latest) {
                    Intent intent = null;
                    intent = new Intent(Fatwa_ListActivity_Networking.this, Fatwa_ListActivity_Networking.class);
                    intent.putExtra(Constants.TITLE, "تازہ ترین جوابات");
                    intent.putExtra(Constants.LATEST,true);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                }  else if (id == R.id.subs) {
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, Subscribe.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.other) {
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, OtherProjects.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                } else if (id == R.id.favo) {
                    Intent intent = new Intent(Fatwa_ListActivity_Networking.this, FavouriteFatwaActivity.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
                }
    ...
    Activity activity = Fatwa_ListActivity_Networking.this;
        ...
        retry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isNetworkAvailable() && isOnline())
                {
                    ...
                    Toast.makeText(Fatwa_ListActivity_Networking.this, "No internet", Toast.LENGTH_SHORT).show();
                }
    ...
    public void loadingData(Bundle b)
    {
        if(b.getInt(Constants.KUTUB,-1) != -1) {
            ...
            final ItemAdapter adapter = new ItemAdapter(this,Fatwa_ListActivity_Networking.this);
